...
if(isset($_POST['submit'])){
  ...
  header("Location:demande-client-accepte.php");
...
<a href="demande-client.php" id="a1"><button class="button-29">Voir demandes en attente</button></a>
</body>
</html>