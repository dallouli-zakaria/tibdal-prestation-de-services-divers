...
<a href="deconn.php">Deconnecter</a>
    ...
    <div class="cards-list">
        ...
        <div class="cards-list">
            ...
            <div id="divb">
            <button class="button-29"><a id="a1" href="../demandes-client/demande-client.php">Voir mes demandes</a></button><?php echo "     ";?>
            <button class="button-29" type="submit" name="submit">Suivant</button>  
            </div>
            </form>
</body>
</html>