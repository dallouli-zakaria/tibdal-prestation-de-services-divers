...
if($_SESSION['connectee']=="ok"){
	...
	header("Location:../prest-dashboard/prest-dashboard.php");
...
<div class="box-form">
    ...
    <p>oubien inscrivez vous !</p>
		...
		<div class="inputs">
			<div id="dvv">je suis prestateur<input type="radio" name="rd1" id="rd1" value="prestateur" ></div>
			<div id="dvv">je suis client<input type="radio"  name="rd1" id="rd1" value="client" checked></div>
